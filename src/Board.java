...
public class Board extends KolkoIKrzyzyk{
    public static void playerTurn(Scanner scanner, char[][] board) {
   ...
   public static void secondPlayerTurn(Scanner scanner, char[][] board) {
    ...
    public static boolean isValidMove(char[][] board, int rowNumber, int columnNumber) {
        return board[rowNumber][columnNumber] == ' ' && rowNumber >= 0 && rowNumber < 3 && columnNumber >= 0 && columnNumber < 3;
    }

   public static boolean endGame(char[][] board, char player) {
        for (int i = 0; i < 3; i++) {
